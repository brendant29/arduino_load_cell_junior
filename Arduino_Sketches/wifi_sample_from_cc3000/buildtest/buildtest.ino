...
*/
  ...
  */
  ...
  uint32_t ip = 0;
  Serial.print(F("winter-runoff.soils.wisc.edu -> "));
  /* while  (ip  ==  0)  {
    if  (!  cc3000.getHostByName("winter-runoff.soils.wisc.edu", &ip))  {
      Serial.println(F("Couldn't resolve!"));
    }
    delay(500);
  }
  */
  /* Can I, erm, ping myself? */;
  ...
  uint8_t replies = cc3000.ping(ip, 50);
...
String PostData = "csv_line=replace_this_with_fake_data";
