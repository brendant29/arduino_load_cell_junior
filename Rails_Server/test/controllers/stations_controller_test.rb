...
class StationsControllerTest < ActionController::TestCase
  ...
  test "should create station" do
    assert_difference('Station.count') do
      post :create, station: { lat: @station.lat, lon: @station.lon, name: @station.name, notes: @station.notes }
    end
  ...
  test "should update station" do
    patch :update, id: @station, station: { lat: @station.lat, lon: @station.lon, name: @station.name, notes: @station.notes }
    assert_redirected_to station_path(assigns(:station))
  end
